...
+ **projets en cours**:
  ...
  + [moteur d'échecs](https://lichess.org/@/fiasco-bot) construit avec [python-chess](https://github.com/niklasf/python-chess)
+ **projets en pause / finis**:
  + système de reconnaissance faciale en temps réel avec [face-recognition](https://github.com/ageitgey/face_recognition) et [opencv](https://pypi.org/project/opencv-python/)
